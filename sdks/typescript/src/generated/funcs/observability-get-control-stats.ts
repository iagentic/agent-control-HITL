 ...
 */
export function observabilityGetControlStats(
...
> {
  ...
  const path = pathToFunc("/api/v1/observability/stats/controls/{control_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ControlStatsResponse$inboundSchema),
