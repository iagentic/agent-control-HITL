 ...
 */
export function observabilityGetStats(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetStatsApiV1ObservabilityStatsGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/observability/stats")();
  ...
  const context = {
    ...
    operationID: "get_stats_api_v1_observability_stats_get",
    oAuth2Scopes: null,
